...
@section('content')
    <h1 class="my-5 text-3xl text-center">Difference in styles</h1>
    <div class="mt-20"></div>
    ...
    <div class="flex items-center max-w-sm p-6 mx-auto mt-10 space-x-4 bg-white shadow-md rounded-xl">
